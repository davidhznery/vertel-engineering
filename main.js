// Vertice Engineering - Website Main Logic
...
const translations = {
    en: {
        ...
        'hero-subtitle': 'Boutique engineering services for the Latin American Oil & Gas industry. Specializing in Consulting, Detail Engineering, and Project Management.',
        ...
        'footer-desc': 'Professional engineering services for Latin America\'s energy future.',
        'footer-links-title': 'Quick Links',
        'footer-contact-title': 'Contact Us',
        'footer-copy': '&copy; 2025 Vertice Engineering. All rights reserved.',
        'contact-title': 'Contact Us',
        'contact-subtitle': 'Get in touch with our engineering team to discuss your next project.',
        'contact-loc-title': 'Regional Offices',
    ...
    es: {
        ...
        'hero-subtitle': 'Servicios de ingeniería boutique para la industria de Oil & Gas en América Latina. Especialistas en Consultoría, Ingeniería de Detalle y Gerencia de Proyectos.',
        ...
        'footer-desc': 'Servicios de ingeniería profesional para el futuro energético de América Latina.',
        'footer-links-title': 'Enlaces Rápidos',
        'footer-contact-title': 'Contáctenos',
        'footer-copy': '&copy; 2025 Vertice Engineering. Todos los derechos reservados.',
        'contact-title': 'Contacto',
        'contact-subtitle': 'Póngase en contacto con nuestro equipo de ingeniería para discutir su próximo proyecto.',
        'contact-loc-title': 'Oficinas Regionales',
